...
2. **For phone:** [Click here](https://github.com/SapirKro/myjoystick/blob/master/myjoystickapp.apk) to download the app (myjoystickapp.apk) and install it on your phone.(make make sure "install from Unknown sources" is allowed).  
